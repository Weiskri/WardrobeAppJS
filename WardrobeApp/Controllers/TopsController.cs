...
namespace WardrobeApp.Controllers
{
    public class TopsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TopsID,Name,Photo,Color,Occasion,Type,Season")] Top top)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopsID,Name,Photo,Color,Occasion,Type,Season")] Top top)
        {
            if (ModelState.IsValid)
            {
