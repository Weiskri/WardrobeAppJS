...
namespace WardrobeApp.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomsID,Name,Photo,Color,Occasion,Type,Season")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomsID,Name,Photo,Color,Occasion,Type,Season")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
