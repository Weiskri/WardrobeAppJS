...
namespace WardrobeApp.Controllers
{
    public class OutfitsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OutfitsID,Name,Occasion,Season,TopsID,BottomsID,ShoesID,AccessoriesID")] Outfit outfit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OutfitsID,Name,Occasion,Season,TopsID,BottomsID,ShoesID,AccessoriesID")] Outfit outfit)
        {
            if (ModelState.IsValid)
            {
